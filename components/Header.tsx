...
const Header: React.FC = () => {
  return (
    <header className="w-full py-4 px-8 border-b-2 border-black bg-[#F8F4E6] sticky top-0 z-50">
      <div className="flex items-center justify-center gap-3">
          <SparkleIcon className="w-6 h-6 text-teal-500" />
          <h1 className="text-xl font-bold tracking-tight text-gray-900" style={{ fontFamily: "'Press Start 2P', cursive" }}>
            BananaFits
          </h1>
      </div>
    </header>
